  ...
  content = templatefile("files/emr/certificate_setup.sh",
    {
      ...
      acm_cert_arn                  = aws_acm_certificate.emr_ingest_hbase.arn
  ...
  content = templatefile("files/ingest_emr/cloudwatch.sh.tpl",
    {
      ...
      cwa_cdl_loggrp_name                 = data.terraform_remote_state.ingestion.outputs.corporate_data_loader.log_group_name
      cwa_hdl_loggrp_name                 = data.terraform_remote_state.ingestion.outputs.historic_data_loader.log_group_name
